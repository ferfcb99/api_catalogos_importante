...
public class ValidacionesException extends RuntimeException {
     ...
     * @param message
     */
    public ValidacionesException(final String message) {
     ...
     * @param codigo
     */
    public ValidacionesException( final String codigo, final String message, final String mensaje) {
     ...
     * @param throwable
     */
    public ValidacionesException(final String message, final Throwable throwable) {
